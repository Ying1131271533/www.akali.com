<?php
//000000000000s:8381:"<!DOCTYPE html>
			...
			<div class="header_top">
				...
				<div class="container">
					...
					<ul class="nav nav-pills">
						...
						<li><a href="/wed/logins/index.html">登录</a></li>

						<li><a href="/wed/logins/reg.html">免费注册</a></li>

						<li><a href="/wed/logins/logout.html">退出登录</a></li>
			...
			<div class="container">
				...
				<div class="nav_first collapse navbar-collapse" id="example-navbar-collapse">
					...
					<ul class="nav navbar-nav">
						...
						<li><a  href="/wed/about/index.html">品牌介绍</a></li>

						<li><a  href="/wed/article/index.html">新闻中心</a></li>
						
						<li><a  class="" href="/wed/goods/index.html">产品中心</a></li>

						<li><a  href="/wed/message/index.html">联系我们</a></li>

						<li><a  href="/wed/user/index.html">个人中心</a></li>
				...
				<script>
					...
					$(function(){
						$.post("/wed/cart/ajaxgetcount.html", {}, function(data){
		...
		<div class="row">
			...
			<div class="text-left col-sm-3">
				...
				<ul class="nav">
					...
					<li><a href="/wed/goods/index.html" style="background-color: rgb(192, 180, 162);">产品推介</a></li>

					<li class="default" style="background-color: rgb(58, 109, 132);"><a href="/wed/about/index.html">关于JHV</a></li>

					<li><a href="/wed/article/index.html" style="background-color: rgb(58, 109, 132);">旗下品牌</a></li>

					<li><a href="/wed/message/index.html" style="background-color: rgb(115, 55, 55);">招商加盟</a></li>

					<li><a href="/wed/about/index.html" style="background-color: rgb(115, 55, 55);">社会责任</a></li>

					<li><a href="/wed/user/index.html" style="background-color: rgb(192, 180, 162);">个人中心</a></li>
			...
			<div class="col-sm-9 col-xs-12">
				...
				<a href="/wed/goods/index.html"><img class="img-responsive" src="/static/wed/img/banner.png" alt="banner"></a>
...
<div class="search">
	...
	<form name="form" action="/wed/goods/index.html" method="get">
