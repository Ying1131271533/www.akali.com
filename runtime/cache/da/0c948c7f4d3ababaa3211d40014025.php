<?php
//000000000000s:8669:"<!DOCTYPE html>
			...
			<div class="container">
				...
				<div class="nav_first collapse navbar-collapse" id="example-navbar-collapse">
					...
					<ul class="nav navbar-nav">
						...
						<li><a  class="" href="http://www.akali.com/goods/index.html">产品中心</a></li>
		...
		<div class="row">
			...
			<div class="text-left col-sm-3">
				...
				<ul class="nav">
					...
					<li><a href="http://www.akali.com/goods/index.html" style="background-color: rgb(192, 180, 162);">产品推介</a></li>

					<li class="default" style="background-color: rgb(58, 109, 132);"><a href="http://www.akali.com/about/index.html">关于JHV</a></li>

					<li><a href="http://www.akali.com/article/index.html" style="background-color: rgb(58, 109, 132);">旗下品牌</a></li>

					<li><a href="http://www.akali.com/message/index.html" style="background-color: rgb(115, 55, 55);">招商加盟</a></li>

					<li><a href="http://www.akali.com/about/index.html" style="background-color: rgb(115, 55, 55);">社会责任</a></li>

					<li><a href="http://www.akali.com/user/index.html" style="background-color: rgb(192, 180, 162);">个人中心</a></li>
			...
			<div class="col-sm-9 col-xs-12">
				...
				<a href="http://www.akali.com/goods/index.html"><img class="img-responsive" src="/static/wed/img/banner.png" alt="banner"></a>
...
<div class="search">
	...
	<form name="form" action="http://www.akali.com/goods/index.html" method="get">
